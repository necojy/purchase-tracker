...
type Props = { items: Item[]; refreshData: () => void; onClose: () => void; };

export default function RecordForm({ items, refreshData, onClose }: Props) {
  ...
  return (
    <div className="bg-white rounded-3xl p-4 sm:p-6 shadow-sm border border-gray-100 mb-4 animate-fade-in relative">
      <button onClick={onClose} className="absolute top-4 right-4 text-gray-400 hover:text-red-500 font-bold px-2">✕</button>
